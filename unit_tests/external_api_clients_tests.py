...
class quoteAPI(TestCase):
    @patch('app.web_client.external_api_clients.QuoteAPI.__call__')
...
class jokeAPI(TestCase):
    ...
    @patch('app.web_client.external_api_clients.JokeAPI.__call__')
    def test_verify_client(self, mock_get_value: MagicMock) -> None:
        mock_get_value.return_value = 'client'
...
class gifAPI(TestCase):
    ...
    @patch('app.web_client.external_api_clients.MoodAPI.__call__')
    def test_verify_client(self, mock_get_value: MagicMock) -> None:
        mock_get_value.return_value = 'client'
